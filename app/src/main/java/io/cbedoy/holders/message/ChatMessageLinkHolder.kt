...
class ChatMessageLinkHolder(override val containerView: View) : ChatMessagePlainHolder(containerView){
    override fun reload(data: Any) {
        ...
        chat_plain_link_message_container_title.typeface = EasyFonts.robotoBold(containerView.context)
        chat_plain_link_message_container_description.typeface = EasyFonts.robotoRegular(containerView.context)
